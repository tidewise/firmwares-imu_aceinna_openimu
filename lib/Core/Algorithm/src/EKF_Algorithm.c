...
{
    CorrMags_B[X_AXIS] = (real)gEKFOutput.corrAccel_B[X_AXIS];
    CorrMags_B[Y_AXIS] = (real)gEKFOutput.corrAccel_B[Y_AXIS];
    CorrMags_B[Z_AXIS] = (real)gEKFOutput.corrAccel_B[Z_AXIS];
